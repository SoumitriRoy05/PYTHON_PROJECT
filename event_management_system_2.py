...
def view_tickets():
    if not tickets:
        ...
        ticket_table = [[i + 1, ticket['event'], ticket['booked_by'], ticket['num_tickets']] for i, ticket in enumerate(tickets)]
        print(tabulate(ticket_table, headers=["#", "Event", "Booked By", "Tickets Booked"], tablefmt="grid"))
